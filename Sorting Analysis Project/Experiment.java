...
public class Experiment {
	...
	*/
	public static int datapoints = 20;
	...
	*/
	...
	public static void main(String[] args) {
		...
		// java Experiment algo -d datafile -o alpha -f output.csv
	...
	public static void run_experiment() {
		// Incrementally increase array size (i.e. "n"), sorting each time.
		...
		for (int i=0; i<datapoints; i++) {
			// Create a new array of size (i+1)*increment
